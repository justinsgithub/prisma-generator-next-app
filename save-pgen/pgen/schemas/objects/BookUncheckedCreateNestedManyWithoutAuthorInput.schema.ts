...
const Schema: z.ZodType<Prisma.BookUncheckedCreateNestedManyWithoutAuthorInput> = z
  .object({
    create: z
      .union([
...
export const BookUncheckedCreateNestedManyWithoutAuthorInputObjectSchema = Schema
