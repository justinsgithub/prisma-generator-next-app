...
const Schema: z.ZodType<Prisma.PostUncheckedCreateNestedManyWithoutAuthorInput> = z
  .object({
    create: z
      .union([
...
export const PostUncheckedCreateNestedManyWithoutAuthorInputObjectSchema = Schema
