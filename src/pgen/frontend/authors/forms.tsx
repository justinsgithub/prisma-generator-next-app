            ...
            <form className='space-y-4 md:space-y-6' onSubmit={handleSubmit(onSubmit)}>
              <div>
                ...
                <input
                  ...
                  {...register('username')}
                />
                {errors.username && <span className='mt-2 block text-red-800'>{errors.username?.message}</span>}
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  {...register('password')}
                />
                {errors.password && <span className='mt-2 block text-red-800'>{errors.password?.message}</span>}
              </div>
              <div>
                ...
                />
                {errors.confirmPassword && <span className='mt-2 block text-red-800'>{errors.confirmPassword?.message}</span>}
              </div>
              ...
              {errors.terms && <span className='mt-2 block text-red-800'>{errors.terms?.message}</span>}
              <button
                type='submit'
