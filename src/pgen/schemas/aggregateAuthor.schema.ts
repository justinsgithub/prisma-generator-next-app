...
import { AuthorAvgAggregateInputObjectSchema } from './objects/AuthorAvgAggregateInput.schema'
import { AuthorSumAggregateInputObjectSchema } from './objects/AuthorSumAggregateInput.schema'

export const AuthorAggregateSchema = z.object({
  orderBy: z.union([AuthorOrderByWithRelationInputObjectSchema, AuthorOrderByWithRelationInputObjectSchema.array()]).optional(),
  where: AuthorWhereInputObjectSchema.optional(),
  cursor: AuthorWhereUniqueInputObjectSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  _count: z.union([z.literal(true), AuthorCountAggregateInputObjectSchema]).optional(),
  _min: AuthorMinAggregateInputObjectSchema.optional(),
  _max: AuthorMaxAggregateInputObjectSchema.optional(),
  _avg: AuthorAvgAggregateInputObjectSchema.optional(),
  _sum: AuthorSumAggregateInputObjectSchema.optional(),
})
