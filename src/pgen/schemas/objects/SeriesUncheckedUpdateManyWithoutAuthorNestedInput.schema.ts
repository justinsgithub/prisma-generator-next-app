...
const Schema: z.ZodType<Prisma.SeriesUncheckedUpdateManyWithoutAuthorNestedInput> = z
  .object({
    create: z
      .union([
...
export const SeriesUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema = Schema
