...
const Schema: z.ZodType<Prisma.BookWhereInput> = z
  .object({
    ...
    genre: z.union([z.lazy(() => GenreRelationFilterObjectSchema), z.lazy(() => GenreWhereInputObjectSchema)]).optional(),
    ...
    series: z
      ...
      .optional()
      .nullable(),
    seriesId: z.union([z.lazy(() => IntFilterObjectSchema), z.number()]).optional(),
  })
  .strict()
