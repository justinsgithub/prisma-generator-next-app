...
const Schema: z.ZodType<Prisma.BookUncheckedCreateNestedManyWithoutSeriesInput> = z
  .object({
    create: z
      .union([
...
export const BookUncheckedCreateNestedManyWithoutSeriesInputObjectSchema = Schema
