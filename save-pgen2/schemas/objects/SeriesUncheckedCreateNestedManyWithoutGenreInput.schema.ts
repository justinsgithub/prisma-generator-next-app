...
const Schema: z.ZodType<Prisma.SeriesUncheckedCreateNestedManyWithoutGenreInput> = z
  .object({
    create: z
      .union([
...
export const SeriesUncheckedCreateNestedManyWithoutGenreInputObjectSchema = Schema
