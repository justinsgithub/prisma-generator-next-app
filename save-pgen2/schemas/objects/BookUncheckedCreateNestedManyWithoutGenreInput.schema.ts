...
const Schema: z.ZodType<Prisma.BookUncheckedCreateNestedManyWithoutGenreInput> = z
  .object({
    create: z
      .union([
...
export const BookUncheckedCreateNestedManyWithoutGenreInputObjectSchema = Schema
